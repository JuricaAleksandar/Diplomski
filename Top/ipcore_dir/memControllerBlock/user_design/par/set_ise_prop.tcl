...
xfile add "../rtl/memControllerBlock.vhd"

xfile add "memControllerBlock.ucf"
...
project set "Library Search Order" "../synth/memControllerBlock.lso" -process "Synthesize - XST"
