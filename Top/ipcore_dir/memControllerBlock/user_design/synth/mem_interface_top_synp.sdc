...
define_attribute          {v:work.memControllerBlock} syn_hier {hard}

# clock Constraints
define_clock -disable -name {memc3_infrastructure_inst} -period 4000 -clockgroup default_clkgroup_1
define_clock          -name {memc3_infrastructure_inst.SYS_CLK_INST} -period 4000 -clockgroup default_clkgroup_2
define_clock -disable -name {memc3_infrastructure_inst.u_pll_adv} -period 4000 -clockgroup default_clkgroup_3
