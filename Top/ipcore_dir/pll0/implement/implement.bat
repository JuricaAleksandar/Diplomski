...
xst -ifn xst.scr
move pll0_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\pll0_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc pll0_exdes.ucf pll0_exdes

echo 'Running map'
map -timing -pr b pll0_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm pll0_exdes -w routed.ncd routed.vhd
cd ..
