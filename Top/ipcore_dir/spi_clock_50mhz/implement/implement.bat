...
xst -ifn xst.scr
move spi_clock_50mhz_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\spi_clock_50mhz_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc spi_clock_50mhz_exdes.ucf spi_clock_50mhz_exdes

echo 'Running map'
map -timing -pr b spi_clock_50mhz_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm spi_clock_50mhz_exdes -w routed.ncd routed.vhd
cd ..
