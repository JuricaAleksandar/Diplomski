...
LAB43:    if (*((unsigned int *)t70) > 0)
        goto LAB44;

LAB45:    if (*((unsigned int *)t61) > 0)
        goto LAB46;

LAB47:    memcpy(t60, t74, 8);

LAB48:    goto LAB24;

LAB25:    xsi_vlog_unsigned_bit_combine(t23, 1, t37, 1, t60, 1);
    goto LAB29;
...
LAB44:    xsi_vlog_unsigned_bit_combine(t60, 1, t75, 1, t74, 1);
    goto LAB48;

LAB46:    memcpy(t60, t75, 8);
    goto LAB48;

}


extern void secureip_m_00000000001720931726_1889964038_init()
{
	static char *pe[] = {(void *)Cont_15_0,(void *)Cont_17_1,(void *)Cont_18_2,(void *)Always_20_3,(void *)Cont_28_4};
	xsi_register_didat("secureip_m_00000000001720931726_1889964038", "isim/colorBarGenerator_tb_isim_beh.exe.sim/secureip/m_00000000001720931726_1889964038.didat");
