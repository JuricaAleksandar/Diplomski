...
#endif
static const char *ng0 = "v:/hipsBuilds/P_hips_v21.0/rst/hips/mcb/memc_calibration_datacheck_dq.v";
...
LAB106:    if (*((unsigned int *)t92) != 0)
        goto LAB107;

LAB108:    t107 = *((unsigned int *)t85);
    t108 = *((unsigned int *)t99);
    t109 = (t107 & t108);
    *((unsigned int *)t106) = t109;
    t98 = (t85 + 4);
...
LAB115:    xsi_set_current_line(846, ng0);
    ...
    t148 = ((char*)((ng7)));
    memset(t151, 0, 8);
    xsi_vlog_unsigned_divide(t151, 32, t147, 8, t148, 32);
    memset(t152, 0, 8);
    xsi_vlog_unsigned_minus(t152, 32, t144, 8, t151, 32);
    t149 = (t0 + 8924);
    xsi_vlogvar_wait_assign_value(t149, t152, 0, 0, 8, 0LL);
...
extern void secureip_m_00000000002905671792_3836920182_init()
{
	...
	xsi_register_didat("secureip_m_00000000002905671792_3836920182", "isim/colorBarGenerator_tb_isim_beh.exe.sim/secureip/m_00000000002905671792_3836920182.didat");
