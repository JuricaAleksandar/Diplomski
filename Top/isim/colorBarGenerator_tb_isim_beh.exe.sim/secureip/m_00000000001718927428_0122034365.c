...
static void Cont_964_0(char *t0)
{
    char t3[8];
    char t4[8];
    char t6[8];
...
LAB16:    t443 = (t0 + 1868);
    ...
    *((unsigned int *)t453) = (t455 | t449);
    xsi_driver_vfirst_trans(t443, 0, 0);
    t456 = (t0 + 1824);
    *((int *)t456) = 1;
...
LAB31:    xsi_vlog_unsigned_bit_combine(t57, 1, t80, 1, t112, 1);
    goto LAB35;

LAB33:    memcpy(t57, t80, 8);
    goto LAB35;

LAB36:    *((unsigned int *)t80) = 1;
    goto LAB39;

LAB41:    t102 = *((unsigned int *)t80);
...
LAB70:    if (*((unsigned int *)t168) > 0)
        goto LAB71;

LAB72:    memcpy(t167, t222, 8);

LAB73:    goto LAB49;

LAB50:    xsi_vlog_unsigned_bit_combine(t112, 1, t135, 1, t167, 1);
    goto LAB54;

LAB52:    memcpy(t112, t135, 8);
    goto LAB54;

LAB55:    *((unsigned int *)t135) = 1;
    goto LAB58;

LAB60:    t157 = *((unsigned int *)t135);
...
LAB87:    if (*((unsigned int *)t241) > 0)
        goto LAB88;

LAB89:    if (*((unsigned int *)t223) > 0)
        goto LAB90;

LAB91:    memcpy(t222, t277, 8);

LAB92:    goto LAB68;

LAB69:    xsi_vlog_unsigned_bit_combine(t167, 1, t190, 1, t222, 1);
    goto LAB73;

LAB71:    memcpy(t167, t190, 8);
    goto LAB73;

LAB74:    *((unsigned int *)t190) = 1;
    goto LAB77;

LAB79:    t212 = *((unsigned int *)t190);
...
LAB96:    t263 = (t245 + 4);
    ...
    t266 = (~(t265));
    *((unsigned int *)t245) = t266;
    *((unsigned int *)t263) = 0;
    if (*((unsigned int *)t264) != 0)
        goto LAB98;

LAB97:    t271 = *((unsigned int *)t245);
    *((unsigned int *)t245) = (t271 & 1U);
...
LAB106:    if (*((unsigned int *)t296) > 0)
        goto LAB107;

LAB108:    if (*((unsigned int *)t278) > 0)
        goto LAB109;

LAB110:    memcpy(t277, t332, 8);

LAB111:    goto LAB87;

LAB88:    xsi_vlog_unsigned_bit_combine(t222, 1, t245, 1, t277, 1);
    goto LAB92;

LAB90:    memcpy(t222, t245, 8);
    goto LAB92;

LAB93:    *((unsigned int *)t245) = 1;
    goto LAB96;

LAB98:    t267 = *((unsigned int *)t245);
    t268 = *((unsigned int *)t264);
    *((unsigned int *)t245) = (t267 | t268);
    t269 = *((unsigned int *)t263);
    t270 = *((unsigned int *)t264);
    *((unsigned int *)t263) = (t269 | t270);
    goto LAB97;

LAB99:    *((unsigned int *)t278) = 1;
    goto LAB102;
...
LAB125:    if (*((unsigned int *)t351) > 0)
        goto LAB126;

LAB127:    if (*((unsigned int *)t333) > 0)
        goto LAB128;

LAB129:    memcpy(t332, t387, 8);

LAB130:    goto LAB106;

LAB107:    xsi_vlog_unsigned_bit_combine(t277, 1, t300, 1, t332, 1);
    goto LAB111;

LAB109:    memcpy(t277, t300, 8);
    goto LAB111;

LAB112:    *((unsigned int *)t300) = 1;
    goto LAB115;

LAB117:    t322 = *((unsigned int *)t300);
...
LAB134:    t373 = (t355 + 4);
    t374 = (t358 + 4);
    t375 = *((unsigned int *)t358);
    t376 = (~(t375));
    *((unsigned int *)t355) = t376;
    *((unsigned int *)t373) = 0;
    if (*((unsigned int *)t374) != 0)
        goto LAB136;

LAB135:    t381 = *((unsigned int *)t355);
    *((unsigned int *)t355) = (t381 & 1U);
...
LAB144:    if (*((unsigned int *)t406) > 0)
        goto LAB145;

LAB146:    if (*((unsigned int *)t388) > 0)
        goto LAB147;

LAB148:    memcpy(t387, t442, 8);

LAB149:    goto LAB125;

LAB126:    xsi_vlog_unsigned_bit_combine(t332, 1, t355, 1, t387, 1);
    goto LAB130;

LAB128:    memcpy(t332, t355, 8);
    goto LAB130;

LAB131:    *((unsigned int *)t355) = 1;
    goto LAB134;

LAB136:    t377 = *((unsigned int *)t355);
    t378 = *((unsigned int *)t374);
    *((unsigned int *)t355) = (t377 | t378);
    t379 = *((unsigned int *)t373);
    t380 = *((unsigned int *)t374);
    *((unsigned int *)t373) = (t379 | t380);
    goto LAB135;

LAB137:    *((unsigned int *)t388) = 1;
    goto LAB140;
...
LAB154:    t436 = *((unsigned int *)t410);
    *((unsigned int *)t410) = (t436 & 1U);
    t437 = *((unsigned int *)t428);
    *((unsigned int *)t428) = (t437 & 1U);
    goto LAB142;

LAB143:    t442 = ((char*)((ng1)));
    goto LAB144;

LAB145:    xsi_vlog_unsigned_bit_combine(t387, 1, t410, 1, t442, 1);
    goto LAB149;

LAB147:    memcpy(t387, t410, 8);
    goto LAB149;

LAB150:    *((unsigned int *)t410) = 1;
    goto LAB153;

LAB155:    t432 = *((unsigned int *)t410);
...
extern void secureip_m_00000000001718927428_0122034365_init()
{
	static char *pe[] = {(void *)Cont_964_0};
	xsi_register_didat("secureip_m_00000000001718927428_0122034365", "isim/colorBarGenerator_tb_isim_beh.exe.sim/secureip/m_00000000001718927428_0122034365.didat");
